            ...
            <Modal size="lg" aria-labelledby="contained-modal-title-vcenter"
                ...
                <Modal.Body>
                    ...
                    <Row>
                        ...
                        <Col sm='12' md='8'>
                            <ReactStars
                                size={46}
                                value={this.state.proposta / 2}
                                onChange={newRating => {
                                    this.setState({ proposta: newRating * 2 })
                                }}
                    ...
                    <Row>
                        ...
                        <Col sm='12' md='8'>
                            <ReactStars
                                size={46}
                                value={this.state.pitch / 2}
                                onChange={newRating => {
                                    this.setState({ pitch: newRating * 2 })
                                }}
                                emptyIcon={<i className="far fa-star" />}
                                halfIcon={<i className="fa fa-star-half-alt" style={{ color: '#5a17f8' }} />}
                                filledIcon={<i className="fa fa-star" style={{ color: '#5a17f8' }} />}
                    ...
                    <Row>
                        ...
                        <Col sm='12' md='8'>
                            <ReactStars
                                size={46}
                                value={this.state.desenv / 2}
                                onChange={newRating => {
                                    this.setState({ desenv: newRating * 2 })
                                }}
                                emptyIcon={<i className="far fa-star" />}
                                halfIcon={<i className="fa fa-star-half-alt" style={{ color: '#5a17f8' }} />}
                                filledIcon={<i className="fa fa-star" style={{ color: '#5a17f8' }} />}
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" onClick={async () => {
                        this.setState({ proposta: 0, pitch: 0, desenv: 0, comment: '' })
